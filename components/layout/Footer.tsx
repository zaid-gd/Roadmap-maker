export default function Footer() {
    return (
        <footer className="border-t border-border py-8 mt-auto bg-obsidian-surface">
            <div className="w-full px-6 lg:px-12 flex flex-col sm:flex-row items-center justify-between gap-4 font-sans-display text-xs uppercase tracking-[0.2em] text-text-secondary">
                <p>
                    POWERED BY{" "}
